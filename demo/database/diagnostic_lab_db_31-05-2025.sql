...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2025 at 02:40 PM
...
(10, 8, '2025-05-21', 250.00, 0.00, 250.00, 'paid', 1, 0, 0, '2025-05-27 13:47:43'),
(11, 10, '2025-05-21', 1300.00, 0.00, 1300.00, 'paid', 1, 0, 0, '2025-05-27 13:47:43'),
(12, 10, '2025-05-27', 350.00, 0.00, 350.00, 'paid', 1, 1, 1, '2025-05-27 16:23:49'),
(13, 6, '2025-05-27', 350.00, 0.00, 350.00, 'paid', 1, 1, 1, '2025-05-27 16:27:08'),
(14, 3, '2025-05-29', 350.00, 0.00, 350.00, 'paid', 1, 1, 1, '2025-05-29 10:54:12'),
...
(1, 'Complete Blood Count', 'CBC', 1, 2, 350.00, 'Includes all major blood cell parameters'),
(2, 'Kidney Function Test', 'KFT', 1, 1, 400.00, 'Includes Urea, Creatinine, Uric Acid, BUN, Calcium'),
(3, 'Liver Function Test', 'LFT', 1, 1, 450.00, 'Includes Bilirubin, SGOT, SGPT, ALP, Protein, Albumin'),
(4, 'Lipid Profile', 'LIPID', 1, 1, 500.00, 'Cholesterol, HDL, LDL, Triglycerides'),
(5, 'Thyroid Profile', 'TFT', 1, 1, 400.00, 'TSH, T3, T4'),
(6, 'Blood Sugar Profile', 'BS', 1, 1, 250.00, 'FBS, PPBS, HbA1c'),
(7, 'Hemoglobin', 'HB', 1, 2, 100.00, 'Hemoglobin level'),
(8, 'HIV Test', 'HIV', 1, 3, 300.00, 'Screening for HIV'),
(9, 'HBsAg Test', 'HBsAg', 1, 3, 300.00, 'Hepatitis B surface antigen'),
(10, 'Coagulation Profile', 'COAG', 1, 2, 350.00, 'PT, aPTT, INR'),
(11, 'Electrolytes Panel', 'ELEC', 1, 1, 250.00, 'Sodium, Potassium, Chloride'),
(12, 'Calcium and Phosphate', 'CALPHOS', 1, 1, 200.00, 'Calcium, Magnesium, Phosphate'),
(13, 'Tumor Markers', 'TUMOR', 1, 3, 600.00, 'Includes PSA, CEA'),
(14, 'Thyroid Antibodies', 'THYAB', 1, 5, 600.00, 'Anti-TPO, Anti-Thyroglobulin'),
(23, 'Vitamin Panel', 'VITPKG', 1, 1, 800.00, 'Vitamin D and B12 levels'),
(24, 'Urine Analysis', 'URINE', 1, 6, 200.00, 'Routine urine analysis'),
(25, 'COVID-19 Panel', 'COVIDPKG', 1, 3, 1200.00, 'Includes RT-PCR, CBC, CRP, D-Dimer'),
(26, 'Urine Routine', 'URINE', 1, 6, 150.00, 'Routine urine examination'),
(27, 'Blood Grouping', 'BLOODGRP', 1, 2, 100.00, 'Blood group and Rh typing'),
(28, 'VDRL Test', 'VDRL', 1, 3, 200.00, 'Syphilis screening test'),
(29, 'Malaria Test', 'MALARIA', 1, 3, 250.00, 'Rapid or microscopy malaria test'),
(30, 'ECG', 'ECG', 2, 6, 300.00, 'Electrocardiogram - heart rhythm test');
...
INSERT INTO `lab_test_parameters` (`id`, `test_id`, `parameter_id`) VALUES
(1, 1, 152),
(2, 1, 153),
(3, 1, 154),
(4, 1, 155),
...
(7, 10, '2025-05-26 13:26:29', 5, 'collected'),
(8, 12, '2025-05-27 16:28:01', 5, 'collected'),
(9, 13, '2025-05-27 16:28:03', 5, 'collected'),
(10, 14, '2025-05-29 10:54:58', 5, 'completed'),
(11, 15, '2025-05-30 16:00:17', 5, 'collected'),
(12, 11, '2025-05-30 18:14:17', 5, 'collected');
...
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'Admin User', 1, 'active'),
