...
<head>
  ...
  <style>
    ...
    table.header-table td { padding: 6px; vertical-align: top; }
...
<div class="container">
    ...
    <tr>
      ...
      <td width="60%">
        <table class="patient-info-table">
          <tr><td><strong>Name</strong></td><td>:</td><td><?= htmlspecialchars($bill['full_name']) ?></td></tr>
          <tr><td><strong>Age</strong></td><td>:</td><td><?= htmlspecialchars($bill['age']) ?></td></tr>
          <tr><td><strong>Gender</strong></td><td>:</td><td><?= ucfirst(htmlspecialchars($bill['gender'])) ?></td></tr>
          <tr><td><strong>Phone</strong></td><td>:</td><td><?= htmlspecialchars($bill['phone']) ?></td></tr>
        </table>
      </td>
      <td width="20%" align="right">
        <div><strong>ID:</strong> <?= htmlspecialchars($bill['patient_id']) ?></div>
        <div><strong>Date:</strong> <?= htmlspecialchars($bill['bill_date']) ?></div>
      ...
      <table class="report-table">
        ...
        <?php foreach ($params as $p): ?>
          <?php
            ...
            // Determine if result should be highlighted
            ...
            // Numeric ref check
            $min = $max = null;
            if (!empty($p['ref_range']) && preg_match('/([\d.]+)\s*-\s*([\d.]+)/', $p['ref_range'], $matches)) {
  ...
  <div class="action-buttons" style="margin-top: 30px; text-align: center;">
    <a href="/dclab/test_entry_list.php" class="btn btn-secondary">← Back to List</a>
...
<!-- JS for PDF (optional if you're using server-side PDF) -->
